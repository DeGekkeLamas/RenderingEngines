...
Shader::Shader(const std::string &shaderPath, GLuint shaderType) {
    shader = generateShader(shaderPath, shaderType);
}
...
GLuint Shader::generateShader(const std::string &shaderPath, const GLuint shaderType) {
